...
search_term = 'meteor lights New England'
...
urls = [
    ...
    'http://www.thehindu.com/search/?order=DESC&ct=text&sort=score&q=' + search_term_plus,
    # search for date but no date in results
